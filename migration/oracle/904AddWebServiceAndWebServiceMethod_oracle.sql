...
-- Spin-Suite Server
INSERT INTO WS_WebService (AD_Client_ID,AD_Org_ID,Created,CreatedBy,Description,IsActive,Name,NameSpace,Updated,UpdatedBy,URL,Value,WS_WebService_ID) VALUES (0,0,TO_DATE('2014-08-05 22:57:06','YYYY-MM-DD HH24:MI:SS'),100,'Spin-Suite Service','Y','Spin-Suite Service','http://www.erpcya.com/',TO_DATE('2014-08-05 22:57:06','YYYY-MM-DD HH24:MI:SS'),100,'http://localhost/ADInterface/services/SpinSuiteService','Spin-Suite',50006)
;
