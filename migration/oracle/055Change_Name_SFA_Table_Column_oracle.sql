...
-- SFAndroid Server
UPDATE AD_Table SET Name='Mobile Table', TableName='SPS_Table',Updated=TO_DATE('2014-02-14 10:13:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53503
;
...
-- SFAndroid Server
UPDATE AD_Element SET ColumnName='SPS_Table_ID', Name='Mobile Table', PrintName='Mobile Table',Updated=TO_DATE('2014-02-14 10:14:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=55949
;
...
-- SFAndroid Server
UPDATE AD_Table SET Name='Mobile Table Translation', TableName='SPS_Table_Trl',Updated=TO_DATE('2014-02-14 10:16:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53504
;
...
-- SFAndroid Server
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNewYear,StartNo,Updated,UpdatedBy) VALUES (0,0,53904,TO_DATE('2014-02-14 10:16:04','YYYY-MM-DD HH24:MI:SS'),100,1000000,50000,'Table SPS_Table_Trl',1,'Y','N','Y','Y','SPS_Table_Trl','N',1000000,TO_DATE('2014-02-14 10:16:04','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2014 10:16:39 AM CET
-- SFAndroid Server
UPDATE AD_Table SET Name='Mobile Column', TableName='SPS_Column',Updated=TO_DATE('2014-02-14 10:16:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53499
;
...
-- SFAndroid Server
UPDATE AD_Element SET ColumnName='SPS_Column_ID', Name='Mobile Column', PrintName='Mobile Column',Updated=TO_DATE('2014-02-14 10:18:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=55947
;
...
-- SFAndroid Server
UPDATE AD_Table SET Name='Translation', TableName='SPS_Column_Trl',Updated=TO_DATE('2014-02-14 10:25:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53500
;
...
-- SFAndroid Server
UPDATE AD_Val_Rule SET Code='EXISTS(SELECT 1 FROM SPS_Table st WHERE st.SPS_Table_ID = @SPS_Table_ID@ AND st.AD_Table_ID = AD_Column.AD_Table_ID)', Name='AD_Column_ID EXISTS in SPS_Table',Updated=TO_DATE('2014-02-14 10:40:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52166
;

-- Feb 14, 2014 10:41:18 AM CET
-- SFAndroid Server
UPDATE AD_Val_Rule SET Code='SPS_Tab.SPS_Table_ID=@SPS_Table_ID@', Name='SPS_Tab equal SPS_Table of Context',Updated=TO_DATE('2014-02-14 10:41:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52312
;
