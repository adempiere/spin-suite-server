...
-- SFAndroid Contribution
UPDATE AD_Table SET TableName='SPS_SyncColumn_Trl',Updated=TO_DATE('2013-06-26 10:39:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53500
;

-- Jun 26, 2013 10:39:56 AM VET
-- SFAndroid Contribution
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNewYear,StartNo,Updated,UpdatedBy) VALUES (0,0,53627,TO_DATE('2013-06-26 10:39:52','YYYY-MM-DD HH24:MI:SS'),100,1000000,50000,'Table SPS_SyncColumn_Trl',1,'Y','N','Y','Y','SPS_SyncColumn_Trl','N',1000000,TO_DATE('2013-06-26 10:39:52','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Jun 26, 2013 10:40:08 AM VET
-- SFAndroid Contribution
UPDATE AD_Element SET ColumnName='SPS_SyncColumn_Trl_ID',Updated=TO_DATE('2013-06-26 10:40:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=55961
;
