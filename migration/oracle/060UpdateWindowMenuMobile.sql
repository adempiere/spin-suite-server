...
-- SFAndroid Server
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52333,'AD_Ref_List.Value=''A''',TO_DATE('2014-03-15 17:05:28','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','SFA_Menu Activity','S',TO_DATE('2014-03-15 17:05:28','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Server
UPDATE AD_Val_Rule SET Code='SFA_Menu.IsSummary = ''Y'' AND AD_Ref_List.Value=''Q''',Updated=TO_DATE('2014-03-15 17:07:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52179
;

-- Mar 15, 2014 5:07:25 PM VET
-- SFAndroid Server
UPDATE AD_Val_Rule SET Code='SFA_Menu.IsSummary = ''Y'' AND AD_Ref_List.Value=''A''', EntityType='ECA01', Name='SFA_Menu Activity Is Sumary',Updated=TO_DATE('2014-03-15 17:07:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52333
;
...
-- SFAndroid Server
UPDATE AD_Val_Rule SET Code='SFA_Menu.IsSummary = ''Y'' AND SFA_Menu.MenuType  = ''A''',Updated=TO_DATE('2014-03-15 17:13:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52333
;

-- Mar 15, 2014 5:17:59 PM VET
-- SFAndroid Server
UPDATE AD_Val_Rule SET Code='SFA_Menu.IsSummary = ''Y'' AND SFA_Menu.MenuType=''Q''',Updated=TO_DATE('2014-03-15 17:17:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=52179
;
...
-- SFAndroid Server
UPDATE AD_Tab SET WhereClause='SFA_Menu.MenuType <> ''M''',Updated=TO_DATE('2014-03-15 18:03:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53917
;

-- Mar 15, 2014 6:03:22 PM VET
-- SFAndroid Server
UPDATE AD_Tab SET WhereClause='SFA_Menu.MenuType <> ''M''',Updated=TO_DATE('2014-03-15 18:03:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53677
;
