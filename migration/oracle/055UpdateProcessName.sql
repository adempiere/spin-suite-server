...
-- SFAndroid Server
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52310,'SPS_SyncColumn.SPS_SyncTable_ID = @SPS_SyncTable_ID@',TO_DATE('2014-02-13 14:47:53','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','SPS_SyncColumn of SFA SyncTable','S',TO_DATE('2014-02-13 14:47:53','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Server
UPDATE AD_Column SET DefaultValue='@SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM SPS_Tab WHERE SPS_Window_ID=@SPS_Window_ID@',Updated=TO_DATE('2014-02-13 15:52:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=71642
;
...
-- SFAndroid Server
UPDATE AD_Process SET Classname='org.sfandroid.process.TabCopy', Description='Copy Fields from other Tab', Name='Copy Tab Fields', Value='SPS_Tab TabCopy',Updated=TO_DATE('2014-02-13 17:21:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53575
;
...
-- SFAndroid Server
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52311,'SPS_Window.SPS_Window_ID <> @SPS_Window_ID@',TO_DATE('2014-02-13 17:29:06','YYYY-MM-DD HH24:MI:SS'),100,'ECA01','Y','SPS_Window not Context ','S',TO_DATE('2014-02-13 17:29:06','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Server
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52312,'SPS_Tab.SPS_SyncTable_ID=@SPS_SyncTable_ID@',TO_DATE('2014-02-13 17:32:39','YYYY-MM-DD HH24:MI:SS'),100,'ECA01','Y','SPS_Tab equal SPS_SyncTable of Context','S',TO_DATE('2014-02-13 17:32:39','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Server
UPDATE AD_Process SET Classname='org.sfandroid.process.WindowCopy', Value='SPS_Window WindowCopy',Updated=TO_DATE('2014-02-13 17:50:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53577
;
