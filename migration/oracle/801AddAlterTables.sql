...
-- SFAndroid Server
ALTER TABLE AD_ReportView ADD SFA_Table_ID NUMBER(10) DEFAULT NULL 
;
...
-- Mar 22, 2014 11:56:51 AM CET
-- SFAndroid Server
ALTER TABLE AD_PrintFormatItem ADD SFA_Column_ID NUMBER(10) DEFAULT NULL 
;
...
-- SFAndroid Server
ALTER TABLE AD_PrintFormat ADD SFA_Table_ID NUMBER(10) DEFAULT NULL 
;
