...
-- SFAndroid Server
UPDATE AD_Table_Trl SET Name='Tabla Móvil',Updated=TO_TIMESTAMP('2014-02-14 10:14:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53503 AND AD_Language='es_MX'
;
...
-- Feb 14, 2014 10:14:48 AM CET
-- SFAndroid Server
UPDATE AD_PrintFormatItem SET PrintName='Mobile Table', Name='Mobile Table' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=55949)
;

-- Feb 14, 2014 10:15:11 AM CET
-- SFAndroid Server
UPDATE AD_Element_Trl SET Name='Tabla Móvil',PrintName='Tabla Móvil',Updated=TO_TIMESTAMP('2014-02-14 10:15:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=55949 AND AD_Language='es_MX'
;
...
-- SFAndroid Server
UPDATE AD_Table_Trl SET Name='Columna de Móvil',Updated=TO_TIMESTAMP('2014-02-14 10:16:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53499 AND AD_Language='es_MX'
;
...
-- Feb 14, 2014 10:18:04 AM CET
-- SFAndroid Server
UPDATE AD_PrintFormatItem SET PrintName='Mobile Column', Name='Mobile Column' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=55947)
;

-- Feb 14, 2014 10:18:33 AM CET
-- SFAndroid Server
UPDATE AD_Element_Trl SET Name='Columna del Móvil',PrintName='Columna del Móvil',Updated=TO_TIMESTAMP('2014-02-14 10:18:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=55947 AND AD_Language='es_MX'
;
...
-- SFAndroid Server
UPDATE AD_Window SET Description='Mobile Table', Help='Table And Column Mobile', Name='Mobile Table',Updated=TO_TIMESTAMP('2014-02-14 10:26:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=53235
;
...
-- SFAndroid Server
UPDATE AD_Menu SET Description='Mobile Table', IsActive='Y', Name='Mobile Table',Updated=TO_TIMESTAMP('2014-02-14 10:26:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53537
;
...
-- SFAndroid Server
UPDATE AD_Window_Trl SET Name='Tabla Móvil',Description='Tabla Móvil',Help='Tabla y Columnas del Móvil',Updated=TO_TIMESTAMP('2014-02-14 10:26:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=53235 AND AD_Language='es_MX'
;

-- Feb 14, 2014 10:27:22 AM CET
-- SFAndroid Server
UPDATE AD_Tab SET Description='Table', Help='Table', Name='Table',Updated=TO_TIMESTAMP('2014-02-14 10:27:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53659
;
...
-- SFAndroid Server
UPDATE AD_Tab_Trl SET Name='Tabla',Description='Tabla',Help='Tablas a Sincronizar y Crear en el Móvil',Updated=TO_TIMESTAMP('2014-02-14 10:27:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53659 AND AD_Language='es_MX'
;

-- Feb 14, 2014 10:28:04 AM CET
-- SFAndroid Server
UPDATE AD_Tab SET Description='Column', Help='Column', Name='Column',Updated=TO_TIMESTAMP('2014-02-14 10:28:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53661
;
...
-- SFAndroid Server
UPDATE AD_Tab_Trl SET Name='Columna',Description='Columna',Help='Columnas a Sincronizar y Crear',Updated=TO_TIMESTAMP('2014-02-14 10:28:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53661 AND AD_Language='es_MX'
;

-- Feb 14, 2014 10:29:49 AM CET
-- SFAndroid Server
UPDATE AD_Menu SET Name='Mobile Application Dictionary',Updated=TO_TIMESTAMP('2014-02-14 10:29:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53595
;
...
-- SFAndroid Server
UPDATE AD_Menu_Trl SET Name='Diccionario de Aplicación (Móvil)',Description='Diccionario de Aplicación (Móvil)',Updated=TO_TIMESTAMP('2014-02-14 10:30:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53595 AND AD_Language='es_MX'
;

-- Feb 14, 2014 10:30:37 AM CET
-- SFAndroid Server
UPDATE AD_Window SET Name='Mobile Window',Updated=TO_TIMESTAMP('2014-02-14 10:30:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=53342
;
...
-- Feb 14, 2014 10:30:37 AM CET
-- SFAndroid Server
UPDATE AD_Menu SET Description=NULL, IsActive='Y', Name='Mobile Window',Updated=TO_TIMESTAMP('2014-02-14 10:30:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53765
;
...
-- SFAndroid Server
UPDATE AD_Tab SET Name='Window',Updated=TO_TIMESTAMP('2014-02-14 10:30:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=53895
;
...
-- SFAndroid Server
UPDATE AD_Window SET Name='Mobile Window, Tab & Field',Updated=TO_TIMESTAMP('2014-02-14 10:33:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=53342
;
...
-- Feb 14, 2014 10:33:13 AM CET
-- SFAndroid Server
UPDATE AD_Menu SET Description=NULL, IsActive='Y', Name='Mobile Window, Tab & Field',Updated=TO_TIMESTAMP('2014-02-14 10:33:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=53765
;
...
-- SFAndroid Server
UPDATE AD_Window_Trl SET Name='Ventana, Pestaña y Campo (Móvil)',Updated=TO_TIMESTAMP('2014-02-14 10:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=53342 AND AD_Language='es_MX'
;

-- Feb 14, 2014 10:37:37 AM CET
-- SFAndroid Server
INSERT INTO AD_UserQuery (AD_Client_ID,AD_Org_ID,AD_Tab_ID,AD_Table_ID,AD_User_ID,AD_UserQuery_ID,Created,CreatedBy,IsActive,Name,Updated,UpdatedBy) VALUES (0,0,102,102,100,50007,TO_TIMESTAMP('2014-02-14 10:37:35','YYYY-MM-DD HH24:MI:SS'),100,'Y','** Last Query **',TO_TIMESTAMP('2014-02-14 10:37:35','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2014 10:39:52 AM CET
-- SFAndroid Server
INSERT INTO AD_UserQuery (AD_Client_ID,AD_Org_ID,AD_Tab_ID,AD_Table_ID,AD_User_ID,AD_UserQuery_ID,Created,CreatedBy,IsActive,Name,Updated,UpdatedBy) VALUES (0,0,108,108,100,50008,TO_TIMESTAMP('2014-02-14 10:39:48','YYYY-MM-DD HH24:MI:SS'),100,'Y','** Last Query **',TO_TIMESTAMP('2014-02-14 10:39:48','YYYY-MM-DD HH24:MI:SS'),100)
;
