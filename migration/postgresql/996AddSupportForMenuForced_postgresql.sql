...
-- Spin-Suite-Contribution 380
UPDATE AD_Element_Trl SET Name='Forzado',PrintName='Forzado',Updated=TO_TIMESTAMP('2015-05-14 19:44:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=57999 AND AD_Language='es_MX'
;

-- May 14, 2015 7:45:13 PM VET
-- Spin-Suite-Contribution 380
INSERT INTO SPS_Column (ColumnName,SPS_Column_ID,AD_Client_ID,AD_Org_ID,Created,CreatedBy,Updated,UpdatedBy,AD_Reference_ID,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsUpdateable,Name,SelectionSeqNo,SeqNo,SPS_Table_ID,IsCentrallyMaintained,EntityType,AD_Element_ID,IsAllowLogging) VALUES ('IsForced',56320,0,0,TO_TIMESTAMP('2015-05-14 19:45:11','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2015-05-14 19:45:11','YYYY-MM-DD HH24:MI:SS'),100,20,1,'Y','N','N','N','N','N','N','N','Y','Forced',0,0,50103,'Y','ECA01',57999,'Y')
;
...
-- Spin-Suite-Contribution 380
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=180,Updated=TO_TIMESTAMP('2015-05-14 19:46:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=76519
;

-- May 14, 2015 7:46:28 PM VET
-- Spin-Suite-Contribution 380
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2015-05-14 19:46:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=76519
;

-- May 14, 2015 7:47:34 PM VET
-- Spin-Suite-Contribution 380
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=160,Updated=TO_TIMESTAMP('2015-05-14 19:47:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=76519
;

-- May 14, 2015 7:47:35 PM VET
-- Spin-Suite-Contribution 380
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=170,Updated=TO_TIMESTAMP('2015-05-14 19:47:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=74528
;

-- May 14, 2015 7:47:35 PM VET
-- Spin-Suite-Contribution 380
UPDATE AD_Field SET IsDisplayed='Y', SeqNo=180,Updated=TO_TIMESTAMP('2015-05-14 19:47:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=72271
;

-- May 14, 2015 7:48:19 PM VET
-- Spin-Suite-Contribution 380
UPDATE AD_Rule SET UpdatedBy=100,Updated=TO_TIMESTAMP('2015-05-14 19:48:19','YYYY-MM-DD HH24:MI:SS') WHERE AD_Rule_ID=50185
;

-- May 14, 2015 7:48:42 PM VET
-- Spin-Suite-Contribution 380
UPDATE SPS_Column SET DefaultValue='N',Updated=TO_TIMESTAMP('2015-05-14 19:48:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE SPS_Column_ID=56320
;

-- May 14, 2015 7:48:48 PM VET
-- Spin-Suite-Contribution 380
UPDATE AD_Column SET DefaultValue='N',Updated=TO_TIMESTAMP('2015-05-14 19:48:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=76493
;

-- May 14, 2015 7:48:53 PM VET
-- Spin-Suite-Contribution 380
UPDATE AD_Rule SET UpdatedBy=100,Updated=TO_TIMESTAMP('2015-05-14 19:48:53','YYYY-MM-DD HH24:MI:SS') WHERE AD_Rule_ID=50185
;
