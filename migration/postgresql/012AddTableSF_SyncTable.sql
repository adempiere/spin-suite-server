...
-- SFAndroid Contribution
UPDATE AD_Table SET TableName='SPS_SyncTable',Updated=TO_TIMESTAMP('2013-06-26 11:10:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=53503
;

-- Jun 26, 2013 11:10:57 AM VET
-- SFAndroid Contribution
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNewYear,StartNo,Updated,UpdatedBy) VALUES (0,0,53630,TO_TIMESTAMP('2013-06-26 11:10:54','YYYY-MM-DD HH24:MI:SS'),100,1000000,50000,'Table SPS_SyncTable',1,'Y','N','Y','Y','SPS_SyncTable','N',1000000,TO_TIMESTAMP('2013-06-26 11:10:54','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Contribution
UPDATE AD_Column SET AD_Element_ID=55949, ColumnName='SPS_SyncTable_ID', Description=NULL, Help=NULL, IsUpdateable='N', Name='Synchronizing Table',Updated=TO_TIMESTAMP('2013-06-26 11:11:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=65774
;
