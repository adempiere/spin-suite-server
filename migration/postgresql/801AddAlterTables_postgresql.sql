...
-- Mar 20, 2015 10:22:32 AM VET
-- SPS
ALTER TABLE AD_Table ADD COLUMN ActriggerLength NUMERIC(10,0) DEFAULT 0 
;

-- Mar 20, 2015 10:22:32 AM VET
-- SPS
ALTER TABLE AD_Column ADD COLUMN IsRange CHAR(1) DEFAULT 'N' 
;

-- Mar 20, 2015 10:22:32 AM VET
-- SPS
ALTER TABLE AD_Field ADD COLUMN IsAllowCopy CHAR(1) DEFAULT 'Y' 
;

-- Mar 20, 2015 10:22:32 AM VET
-- SPS
ALTER TABLE AD_Field ADD COLUMN IsEmbedded CHAR(1) DEFAULT 'N' 
;
