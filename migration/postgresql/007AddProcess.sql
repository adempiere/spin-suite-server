...
-- SFAndroid Contribution
UPDATE AD_Process_Trl SET Name='Copiar Columnas desde Tabla',Description='Copiar Columnas desde Tabla',Updated=TO_TIMESTAMP('2013-06-26 09:46:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53391 AND AD_Language='es_MX'
;

-- Jun 26, 2013 9:47:25 AM VET
-- SFAndroid Contribution
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,126,0,53391,53914,19,'AD_Table_ID',TO_TIMESTAMP('2013-06-26 09:47:20','YYYY-MM-DD HH24:MI:SS'),100,'ECA01',22,'Y','Y','Y','N','Table',10,TO_TIMESTAMP('2013-06-26 09:47:20','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- SFAndroid Contribution
UPDATE AD_Process_Para SET Description='Database Table information', Help='The Database Table provides the information of the table definition',Updated=TO_TIMESTAMP('2013-06-26 09:47:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53914
;
...
-- SFAndroid Contribution
UPDATE AD_Process_Trl SET Name='Generar script de la tabla',Description='Generar script de la tabla',Updated=TO_TIMESTAMP('2013-06-26 09:50:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=53392 AND AD_Language='es_MX'
;
